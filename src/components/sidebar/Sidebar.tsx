      ...
      <aside className={`${style.sidebarBody} ${globalCtx.showMenu ? style.show : ''}`}>
        ...
        <div className={`${style.sidebarMain}`}>
          <div className={`${style.logoBox}`}>
            <NavLink className={`${style.navlogo}`} to="/admin/">
              <img src="/assets/images/utils/just Eat.svg" className={`${style.logoIcon}`} alt="logo" />
          ...
          <div className={`${style.menuList}`}>
            <ul className={`${style.scroll}`}>
              ...
              <li>
                <NavLink className={`${style.signleMenu}`} to="/admin/dashboard">
              ...
              <li className={`${salesList ? `${style.active}` : ''}`}>
                ...
                <ul className={`${style.first}`}>
                  <li>
                    <NavLink to="/admin/sales/orders">
                      <div className={`${style.menuName}`}>Orders</div>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/admin/sales/customers">
                      <div className={`${style.menuName}`}>Customers</div>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/admin/sales/sessions">
              ...
              <li className={`${promotionList ? `${style.active}` : ''}`}>
                ...
                <ul className={`${style.first}`}>
                  <li>
                    <NavLink to="/admin/promotion/combos">
                      <div className={`${style.menuName}`}>Combos</div>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/admin/promotion/coupons">
                      <div className={`${style.menuName}`}>Coupons</div>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/admin/promotion/discount">
                      <div className={`${style.menuName}`}>Discount</div>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/admin/promotion/timed-events">
              ...
              <li className={`${reportsList ? `${style.active}` : ''}`}>
                ...
                <ul className={`${style.first}`}>
                  ...
                  <li>
                    <NavLink to="/admin/reports/miscellaneous">
                  ...
                  <li>
                    <NavLink to="/admin/reports/myreports">
              ...
              <li className={`${inventoryList ? `${style.active}` : ''}`}>
                ...
                <ul className={`${style.first}`}>
                  <li>
                    <NavLink to="/admin/inventory/items">
                  ...
                  <li>
                    <NavLink to="/admin/inventory/purchase">
                      <div className={`${style.menuName}`}>Purchase Orders</div>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/admin/inventory/transfer">
              ...
              <li className={`${settingsList ? `${style.active}` : ''}`}>
                ...
                <ul className={`${style.first}`}>
                  ...
                  <li>
                    <NavLink to="/admin/settings/employes">
                      <div className={`${style.menuName}`}>Employes</div>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/admin/settings/cashiers">
                  ...
                  <li>
                    <NavLink to="/admin/settings/floors">
                  ...
                  <li>
                    <NavLink to="/admin/settings/delivery">
                  ...
                  <li>
                    <NavLink to="/admin/settings/branch">
                      <div className={`${style.menuName}`}>Branches</div>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/admin/settings/devices">
                      <div className={`${style.menuName}`}>Devices</div>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/admin/settings/reservations">
                      <div className={`${style.menuName}`}>Reservations</div>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/admin/settings/warehouses">
                      <div className={`${style.menuName}`}>Warehouses</div>
                    </NavLink>
                  </li>

                  <li>
                    <NavLink to="/admin/settings/reasons">
                      <div className={`${style.menuName}`}>Reasons</div>
                    </NavLink>
                  </li>

                  <li>
                    <NavLink to="/admin/settings/kitchenflows">
                      <div className={`${style.menuName}`}>Kitchen Flows</div>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/admin/settings/charges">
                      <div className={`${style.menuName}`}>Charges</div>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/admin/settings/giftcard">
                      <div className={`${style.menuName}`}>Gift Card</div>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/admin/settings/Generalsettings">
