          ...
          <div className={`${cx.tabsSection}`}>
            ...
            <Form>
              ...
              >
                ...
                <Col lg={8}>
                  <Form.Control type="text" placeholder="United Kindom" />
                </Col>
              </Form.Group>
              <Form.Group
                className={`row align-items-center ${cx.formBox}`}
              ...
              >
                ...
                <Col lg={8}>
                  <Form.Control type="text" placeholder="Euro" />
                </Col>
              </Form.Group>
              <Form.Group
                className={`row align-items-center ${cx.formBox}`}
              ...
              >
                ...
                <Col lg={8}>
                  <Form.Control type="text" placeholder="Delivery business" />
                </Col>
              </Form.Group>
              ...
              >
                ...
                <Col lg={8}>
                  <Form.Control type="text" placeholder="Europe/United Kindom (GMT+01:00)" />
                </Col>
              </Form.Group>
              ...
              >
                ...
                <Col lg={8}>
                  <Form.Control type="text" placeholder="442221635200003" />
                </Col>
              </Form.Group>
